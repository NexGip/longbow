        ...
        <div className={styles.top}>
          <div className={styles.company}>
            <div className={styles.logo}>
              <Image src={"/icon.png"} fill alt={COMPANYNAME} />
            </div>
            <h4>{COMPANYNAME}</h4>
            <p>{`${COMPANYNAME}, is a Thailand-based investment company that offers investment packages to the general public. We specialize in identifying and investing in profitable businesses, helping our clients accumulate wealth and achieve their financial goals.`}</p>
          </div>
