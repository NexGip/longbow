...
export default function Page() {
  ...
  const texts: { title: string; text: string[] }[] = [
    ...
    },
    {
      ...
      text: [
        `1. Carbon Footprint Reduction: Longbow is dedicated to reducing its carbon emissions. We employ energy-efficient hardware, optimize cooling systems, and transition to renewable energy sources whenever feasible.`,
    ...
    },
    {
      ...
      text: [
        `1. Education and Advocacy: Longbow actively engages with our community and the cryptocurrency industry to promote sustainable practices. We believe that education and advocacy are vital in driving change across the sector.`,
    ...
    <main>
      ...
      <div className={styles.main}>
        <div className={styles.container}>
          ...
          <p>
            {`At Longbow, sustainability isn't just a buzzword; it's a fundamental part of our identity. We invite you to be a part of our mission to create a sustainable and eco-conscious future. Together, we can harness the power of cryptocurrency mining while minimizing our environmental impact.`}
          </p>
        </div>
      </div>
    </main>
