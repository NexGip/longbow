...
export default function Page() {
  const texts: { title: string; text: string[] }[] = [
    ...
    },
    {
      title: "Your Choices",
      text: [
        "You have the right to access, correct, or delete your personal information. You may also opt out of receiving promotional communications from us. Please contact us at support@Longbow.com to exercise these rights or if you have any privacy-related concerns.",
      ],
    },
    {
  ...
  return (
    <div className={styles.main}>
      <div className={styles.container}>
        ...
        <div>
          <p>{`Longbow ("we," "our," or "the Company") is committed to protecting the privacy of our users. This Privacy Policy outlines how we collect, use, disclose, and protect your personal information when you access or use our website and services.`}</p>
        </div>
        {texts.map((e, i) => (
          <div key={i}>
            <h3>{e.title}</h3>
