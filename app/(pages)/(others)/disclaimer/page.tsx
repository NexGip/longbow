...
export default function Page() {
  const texts: { title: string; text: string }[] = [
    ...
    },
    {
      ...
      text: "Longbow operates in accordance with relevant laws and regulations, but the cryptocurrency industry is subject to evolving legal frameworks. It is your responsibility to ensure that you comply with any local, national, or international regulations related to cryptocurrency investments in your jurisdiction.",
    },
    {
    ...
    },
    {
      ...
      text: "While we take security measures to protect your data and investments, the nature of online services carries inherent risks. Longbow is not liable for any loss or damage resulting from unauthorized access, breaches, or data loss.",
    },
    {
      title: "Third-Party Links",
      text: "Our website may contain links to third-party websites or resources. Longbow is not responsible for the content, accuracy, or availability of these external sites. Any reliance on third-party content is at your own risk.",
    },
    {
