...
const GettingStarted: React.FC = (): JSX.Element => {
  const steps: {
  ...
  }[] = [
    {
      ...
      body: [
        "Begin your journey by signing up for a Longbow account. It's a quick and straightforward process.",
    ...
    },
    {
      ...
      body: [
        "To start investing, you'll need to add funds to your Longbow account. This is the capital you'll put to work.",
        `Navigate to the "Deposit" section and select your preferred payment method.`,
        "Follow the instructions to transfer funds into your Longbow account.",
      ],
      action: {
        text: "Fund Account",
    ...
    },
    {
      ...
      body: [
        ...
        "Monitor your investment's progress through your Longbow account dashboard.",
      ],
      action: {
        text: "More",
    ...
    },
    {
      ...
      body: [
        ...
        "The choice is yours, and you can easily manage it through your Longbow account.",
      ],
      action: {
        text: "Withdraw",
