...
export const btnStyle =
  "font-size:1rem; font-weight:600; color:#000000; background-color:#fdee86; padding:12px; width:100%; display:block;text-align:center; text-decoration:none;margin:15px 0px;box-sizing: border-box;";
    ...
    emails: [
      {
        ...
        subject: "Welcome to Longbow",
        username: `${user?.username}`,
        messageData: `<p>
               Welcome to Longbow! </p>
               <p>Longbow Investments offers profitable investment packages for professionals and beginners seeking to accumulate wealth. Our expert team invests in profitable businesses, helping you achieve your financial goals.</p>
      ...
      },
      {
        ...
        subject: `${user.username} just signed up at Longbow`,
        username: `Admin`,
        messageData: `<p>
          ...
          transaction.status == 1
            ? `<p>Your ${
                ...
                transaction.type == 0
                  ...
                  : ""
              } <br/> Thank you for choosing Longbow. </p> <a href="${
                process.env.NEXT_PUBLIC_SERVER_URL
              }/dashboard" style="${btnStyle}">My Dashboard</a>`
            : `<p>Your ${
                transaction.type == 0 ? "withdrawal request" : "deposit"
              } was declined. Please confirm the transaction details and try again. <br/> Thank you for choosing Longbow. </p> <a href="${
                process.env.NEXT_PUBLIC_SERVER_URL
              }/dashboard" style="${btnStyle}">My Dashboard</a>`,
      },
    ],
